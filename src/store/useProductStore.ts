...
const initialProducts: Product[] = [
  { id: 1, name: "Limpiador Multiuso", sku: "GR069", barcode: "77501", price: 15.50, stock: 51, category: "Limpieza", color: "bg-blue-50" },
  { id: 2, name: "Papel Aluminio", sku: "GR070", barcode: "77502", price: 8.90, stock: 39, category: "Hogar", color: "bg-gray-50" },
  { id: 3, name: "Manzanas Rojas", sku: "GR002", barcode: "77503", price: 4.50, stock: 68, category: "Frutas", color: "bg-red-50" },
  { id: 4, name: "Aceite Vegetal", sku: "GR025", barcode: "77504", price: 12.00, stock: 25, category: "Despensa", color: "bg-yellow-50" },
  { id: 5, name: "Coca Cola 3L", sku: "GR099", barcode: "77505", price: 11.50, stock: 50, category: "Bebidas", color: "bg-red-100" },
  { id: 6, name: "Inca Kola 1.5L", sku: "GR098", barcode: "77506", price: 7.50, stock: 40, category: "Bebidas", color: "bg-yellow-100" },
  { id: 7, name: "Pan de Molde", sku: "GR055", barcode: "77507", price: 5.80, stock: 20, category: "Panadería", color: "bg-orange-50" },
  { id: 8, name: "Leche Gloria", sku: "GR033", barcode: "77508", price: 4.20, stock: 100, category: "Lácteos", color: "bg-blue-100" },
...
export const useProductStore = create<ProductState>((set, get) => ({
  ...
  getProductByCode: (code) => {
    const state = get();
    return state.products.find((product) => product.sku.toLowerCase() === code.toLowerCase() || product.barcode?.toLowerCase() === code.toLowerCase());
  }
}))